...
@Component({
  selector: 'app-cmrlautocalesc',
  templateUrl: './cmrlautocalesc.component.html',
  styleUrls: ['./cmrlautocalesc.component.css']
})
export class CmrlautocalescComponent implements OnInit {
